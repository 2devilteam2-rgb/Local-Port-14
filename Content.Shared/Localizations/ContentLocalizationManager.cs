...
namespace Content.Shared.Localizations
{
    public sealed class ContentLocalizationManager
    {
        ...
        private const string Culture = "ru-RU"; // Local-Port
        private const string FallbackCulture = "en-US"; // Local-Port
        ...
        public void Initialize()
        {
            ...
            _loc.LoadCulture(fallbackCulture); // Local-Port
            _loc.SetFallbackCluture(fallbackCulture); // Local-Port
            _loc.AddFunction(culture, "MANY", FormatMany); // Local-Port
